  ...
  return (
    ...
    >
      <div className="relative">
        ...
        <button className="absolute top-3 right-3 rounded p-2 bg-white/80 hover:bg-white shadow border border-gray-200">
          <FaHeart className="text-[#19e796]" />
        </button>
      </div>
      <div className="mt-4 flex-1 flex flex-col justify-between">
        <div>
          ...
          <div className="text-sm text-gray-400">Features: {car.carFeatures.length}</div>
        </div>
        <div className={`flex flex-col gap-1 text-gray-300 text-sm my-3`}>
          ...
          <div>{car.carSpecifications.transmission_type}</div>
        </div>
        <div className="flex items-center justify-between mt-3">
          <div className="text-[#19e796] font-bold text-lg">${car.price}</div>
