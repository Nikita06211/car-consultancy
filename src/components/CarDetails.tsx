...
import { OverviewTab, FeaturesTab, SpecificationsTab } from '@/components/TabSection';
...
export default function CarDetails({ car }: CarDetailsProps) {
  ...
  return (
    ...
    <div className="w-full max-w-[1500px] px-4 mx-auto py-6 grid grid-cols-1 lg:grid-cols-[2fr_1fr] gap-6">
